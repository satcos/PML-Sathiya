...
# Data and source for various projects can be stored in different folders
# Data will be stroed in RSource\'ProjectName'\Data
...
# ReadInputData is a wrapper for read.csv function
# It reads filename.csv from 'basePath'\Data folder
...
# Creating a training model with C5.0 classifier
...
modelFit <- train(form = classe ~ ., data=inData, method='C5.0Tree', trControl=trCtrl)
...
# Summary of sample sizes: 17660, 17662, 17660, 17659, 17659, 17660, ... 

# Resampling results

# Accuracy  Kappa  Accuracy SD  Kappa SD
# 0.967     0.958  0.00169      0.00214 
